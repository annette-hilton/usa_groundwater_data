...
# Attempt to split dataframe in two 

# split(lat_long_entire_usa_s, )

# Write resulting dataframe to tsv 

write_tsv(lat_long_entire_usa_s, "lat_long_entire_usa_s.txt")
# write_csv(lat_long_entire_usa_s, "lat_long_entire_usa_s.csv")
...
# write_tsv(lat_long_entire_usa, "lat_long_entire_usa.txt")
# write_csv(lat_long_entire_usa, "lat_long_entire_usa.csv")
