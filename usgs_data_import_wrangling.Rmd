...
### Use anti_join() to identify new sites from 2017 to 2019 

```{r}

# Attempt equivalent of v-lookup in R (anti-join)
# Read in 2017 USGS Data (from Scott Jasechko) 

# usgs_2017 <- readr::read_csv(here::here("lat_long_data", "usgs_2017_data.csv"))
usgs_2017 <- readr::read_tsv(here::here("lat_long_data", "usgs_2017_data.txt"))

# Use anti-join to find non-matches from the new usgs 2019 data and the usgs 2017 data (new sites) 

# First dataframe: "usgs_2017" 
# Second dataframe: "lat_long_entire_usa_s"

new_usgs_sites <- anti_join(lat_long_entire_usa_s, usgs_2017, by = "site_no")
