...
There are not as many observations (rows) as there should be. I suspect R is not actually compiling all 50 states. I suspect it is doing the last two (in the looping process). What have I done wrong here? 
