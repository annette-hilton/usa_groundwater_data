...
You must update this URL by date (most recent date)
...
usgs_rest_all <- 
  ...
  filter(!agency_cd == "5s") %>% 
  mutate(id = str_remove(source, "C:/Users/aeliz/Dropbox/Documents/github/usa_groundwater_data/urls/usgs_rest/usgs_rest_"), 
...
usgs_gwn_all <-
  ...
  set_names() %>% 
    ...
    filter(!agency_cd == "5s") %>% 
    mutate(id = str_remove(source, "C:/Users/aeliz/Dropbox/Documents/github/usa_groundwater_data/urls/usgs_gwn/usgs_gwn_"), 
         id = str_remove(id, ".tsv")) %>% 
